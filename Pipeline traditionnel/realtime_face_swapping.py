...
while True:
    ...
    landmarks_points2 = []
    print (len(faces2))
    if len(faces2) >= 1: # si un ou plusieurs visages détéctés
        face = faces2[0]
        ...
        for n in range(0, 68):
            ...
            if y > max_y :
                max_y = y
        # si l'image est entièrement dans la fenêtre
        if (min_x > 0 and min_y > 0 and max_x < img2.shape[1] and max_y < img2.shape[0]):
